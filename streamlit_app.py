...
with st.sidebar:
  ...
  Leadframe supplier = st.selectbox('Leadframe supplier; MHT=1 / HDS=0',('0','1'))
  ...
  Wire type = st.selectbox('Wire type ; Au=0 / Cu=1',('0','1'))
  ...
  Unit per strip = st.slider('Unit per strip', 110, 3990, 500)
